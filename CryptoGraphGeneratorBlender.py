...
for i, coin in enumerate(coins):
    ...
    coin_bar.keyframe_insert(data_path="scale", frame=10)
    coin_bar.scale = [1, 1, 5]
    coin_bar.keyframe_insert(data_path="scale", frame=50)
    coin_bar.scale = [1, 1, .5]
    coin_bar.keyframe_insert(data_path="scale", frame=70)
    coin_bar.scale = (width, float(usd_price), 1)
    coin_bar.keyframe_insert(data_path="scale", frame=80)
